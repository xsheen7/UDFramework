...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineProfilingProfilerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 18, 8, 5);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Profiling.ProfilerArea _area;translator.Get(L, 1, out _area);
                        ...
                        bool gen_ret = UnityEngine.Profiling.Profiler.GetAreaEnabled( _area );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Object _o = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetRuntimeMemorySizeLong( _o );
        ...
        static int _m_GetMonoHeapSizeLong_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetMonoHeapSizeLong(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
        ...
        static int _m_GetMonoUsedSizeLong_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetMonoUsedSizeLong(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    uint _size = LuaAPI.xlua_touint(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Profiling.Profiler.SetTempAllocatorRequestedSize( _size );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_GetTempAllocatorSize_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        uint gen_ret = UnityEngine.Profiling.Profiler.GetTempAllocatorSize(  );
        ...
        static int _m_GetTotalAllocatedMemoryLong_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetTotalAllocatedMemoryLong(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
        ...
        static int _m_GetTotalUnusedReservedMemoryLong_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetTotalUnusedReservedMemoryLong(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
        ...
        static int _m_GetTotalReservedMemoryLong_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetTotalReservedMemoryLong(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
        ...
        static int _m_GetAllocatedMemoryForGraphicsDriver_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = UnityEngine.Profiling.Profiler.GetAllocatedMemoryForGraphicsDriver(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
