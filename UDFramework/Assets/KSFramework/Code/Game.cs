    ...
    public class Game : KSGame
    {
        ...
        public override IEnumerator OnBeforeInit()
        {
            ...
            if (AppConfig.IsDownloadRes)
            {
                ...
                {
                    UIMsgBoxInfo info = new UIMsgBoxInfo().GetDefalut(
                        I18N.Get("download_error", DownloadManager.Instance.ErrorType), null, I18N.Get("common_ignore"),
                        I18N.Get("common_exit"));
