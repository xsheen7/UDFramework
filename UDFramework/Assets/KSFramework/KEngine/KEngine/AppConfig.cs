...
public class AppConfig
{
    ...
    public const string TableSourcePath = "Product/TableSource";
    public const string ExportLuaPath = "Product/Lua/configs/";
    public const string ExportTsvPath = "Product/TableGen";
    public const string ExportCSharpPath = "Assets/CodeGen/TableGenScripts/";


    //;Folder in Resources
    public const string SettingResourcesPath = "Table";
